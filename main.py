...
if __name__ == "__main__":
    uvicorn.run(main_api.app, host="0.0.0.0", port=8000, log_level="debug", ssl_certfile="certificate.crt", ssl_keyfile="private.key", workers="uvicorn.workers.UvicornWorker", reload=True)
